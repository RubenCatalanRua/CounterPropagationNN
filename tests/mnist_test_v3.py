...
def preprocess_data(X, y, subset_size=1000, random_state=42):
    """
...
def objective(trial):
    ...
    cpnn_clf = CPNNClassifier(
        ...
        kohonen_optimizer_params=kohonen_optimizer_params,
        grossberg_optimizer_params=grossberg_optimizer_params,
...
final_clf = CPNNClassifier(
    ...
    kohonen_optimizer_params=best_params.get("kohonen_optimizer_params", {}),
    grossberg_optimizer_params=best_params.get("grossberg_optimizer_params", {}),
    scheduler_params=best_params.get("scheduler_params", {})
)
