...
class Autoencoder(nn.Module):
    ...
    def train_autoencoder(self, train_data, val_data=None, epochs=50, lr=0.001,
...
class CounterPropagationNetwork(nn.Module):
    def __init__(self, input_size, hidden_size, hidden_layers, output_size, init_method="xavier_uniform"):
...
class CPNNClassifier(CPNNBase):
    ...
    def fit(self, X, y, X_val = None, y_val = None):
        ...
        if self.use_autoencoder:
            ...
            self.autoencoder_ = self.autoencoder_.train_autoencoder(
                X_tensor,
